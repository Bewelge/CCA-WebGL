...
export class PingPongShader {
	...
	setData(data) {
		let newTex = new THREE.DataTexture(
			data,
			this.width,
			this.height,
			THREE.RGBAFormat,
		...
		let oldTex0 = this.renderTarget0
		let oldTex1 = this.renderTarget1

		this.renderTarget0.texture = newTex
		this.renderTarget1.texture = newTex.clone()
